...
use Minioak\FileFieldType\Command\GetUploadFile;
use Minioak\FileFieldType\Command\PerformUpload;
use Minioak\FileFieldType\Validation\ValidateDisk;
...
class FileFieldType extends FieldType
{
     ...
     * @var string
     */
    protected $inputView = 'minioak.field_type.file::input';
    ...
    protected $validators = [
        'valid_disk' => [
            ...
            'message' => 'minioak.field_type.file::validation.valid_disk'
        ]
    ];
